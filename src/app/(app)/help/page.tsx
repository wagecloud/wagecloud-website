...
export default function HelpSupportPage() {
  ...
  const faqs = [
    {
      ...
      answer:
        'To create a new VM, navigate to the \'Create VM\' section from the sidebar. Choose your desired configuration including CPU, RAM, storage, and operating system. Click \'Create\' to deploy your virtual machine.',
    },
    {
      question: 'What are the different VM states and what do they mean?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Yes, you can resize your VM by stopping it first, then selecting the new configuration from the VM management panel. The VM will restart with the new specifications.',
    },
    {
      question: 'How do I connect to my virtual machine?',
      answer:
        'You can connect via SSH for Linux VMs or RDP for Windows VMs. Connection details including IP address and credentials are available in the VM details panel.',
    },
    {
      question: 'What backup options are available?',
      answer:
        'We offer automated daily backups and manual snapshot creation. Backups are retained for 30 days by default. You can restore from any backup point through the VM management interface.',
    },
    {
  ...
  const tickets = [
    {
      id: 'WC-001',
      subject: 'VM not starting after reboot',
      status: 'open',
      priority: 'high',
      created: '2024-01-15',
      updated: '2024-01-16',
