...
const features = [
  ...
  },
  {
    ...
    description: 'Điều chỉnh CPU, RAM và lưu trữ phù hợp với nhu cầu của bạn.',
  },
  {
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="text-center mb-10">
          ...
          <p className="font-extralight text-white text-[22px] leading-[68px]">
            Chúng tôi đã tối ưu hiệu suất ứng dụng với dịch vụ Cloud mạnh mẽ,
            linh hoạt và bảo mật hàng đầu.
          </p>
        </div>
